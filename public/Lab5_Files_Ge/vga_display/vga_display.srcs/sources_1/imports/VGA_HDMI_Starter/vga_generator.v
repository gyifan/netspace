...
module vga_generator(input            clk,
                     ...
                     // Added input/output to take the color from the bram's color table
                     input [3:0] color,
                     output reg [11:0] hcounter = 0,
                     output reg [11:0] vcounter = 0,
...
// 234 128 128
  ...
  always @(hcounter or vcounter) begin
    ...
    colour[23:16] <= {color,4'b0};
    colour[15:8] <= {color,4'b0};
    colour[7:0] <= {color,4'b0};
