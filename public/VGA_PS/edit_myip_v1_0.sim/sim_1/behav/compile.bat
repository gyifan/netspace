...
xelab -m64 --debug typical --relax -L work -L unisims_ver -L unimacro_ver -L secureip --snapshot myip_v1_0_behav --prj U:/public/VGA_PS/edit_myip_v1_0.sim/sim_1/behav/myip_v1_0.prj   work.myip_v1_0   work.glbl
if errorlevel 1 (
