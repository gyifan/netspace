...
#define TESTIP_S00_AXI_SLV_REG0_OFFSET 0
#define TESTIP_S00_AXI_SLV_REG1_OFFSET 4
#define TESTIP_S00_AXI_SLV_REG2_OFFSET 8
#define TESTIP_S00_AXI_SLV_REG3_OFFSET 12
 ...
 *
 * @param   BaseAddress is the base address of the TESTIPdevice.
