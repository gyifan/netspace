...
ssize_t wrp_sendto(int sockfd, const void *buf, size_t len, int flags, const struct sockaddr *dest_addr, socklen_t addrlen)
{
	int retval;
	retval = sendto(sockfd, buf, len, flags, dest_addr, addrlen);
	if(-1 == retval){
...
ssize_t wrp_recvfrom(int sockfd, void *buf, size_t len, int flags, struct sockaddr *src_addr, socklen_t *addrlen)
{
	int retval;
	retval = recvfrom(sockfd, buf, len, flags, src_addr, addrlen);
	if(-1 == retval){
