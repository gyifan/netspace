...
/**
 * This class shows input dialogues and displays a window on the screen.
 * 
 * @author Ge
 * 
 */
public class TriangleViewer {
	...
	public static void main(String[] args) {
		...
		int additionalSpaceForInfo = 150;
		...
		final int frameHeight = (int) Math.max(p1Y, Math.max(p2Y, p3Y))
				+ additionalSpaceForInfo;
		frame.setSize(frameWidth, frameHeight);
		Dimension minimumSize = new Dimension(frameWidth, frameHeight);
